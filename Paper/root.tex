...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Survival functions for charger networks in California. Top panel shows survival function for in-station redundancy. Bottom three panels show survival functions for between-station redundancy for station cliques defined by 5, 10, and 20 minute drive-times respectively.}
	\label{fig:network_histograms}
\end{figure}
