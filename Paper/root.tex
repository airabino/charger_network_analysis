...
\begin{table}[H]
	...
	\begin{tabular}{|C{.6\linewidth}|C{.2\linewidth}|C{.2\linewidth}|}
		...
		\hline {\small Intercept } & 7.684  & 0.000 \\
		\hline {\small Multiplier } & -0.971  & 0.000 \\
		\hline {\small Attitude[T.Neutral] } & 2.766  & 0.000 \\
		\hline {\small Attitude[T.Cautious] } & 3.579  & 0.000 \\
		\hline {\small Multiplier:Attitude[T.Neutral] }  & -5.417 & 0.000 \\
		\hline {\small Multiplier:Attitude[T.Cautious] }  & -3.891 & 0.001 \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|C{.6\linewidth}|C{.2\linewidth}|C{.2\linewidth}|}
		\hline Parameter & $\beta$ & p-value \\
		\hline {\small Intercept } & 6.486 & 0.000 \\
		\hline {\small Multiplier } & -0.128 & 0.000 \\
		\hline
	\end{tabular}
\end{table}
