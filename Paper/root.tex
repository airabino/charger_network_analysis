...
\begin{figure}[H]
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
		\includegraphics[width = \linewidth]{figs/California_RBS_Hist.png}
	\end{subfigure}
	\caption{Survival functions for charger networks in California. Top panel shows survival function for in-station redundancy. Bottom panel shows survival function for redundancy between stations with 10 minute drive-time.}
	\label{fig:network_histograms}
\end{figure}
