...
\begin{table}[H]
	...
	\begin{tabular}{|C{\linewidth * 1 / 3}|C{\linewidth * 2 / 3}|}
		...
		\hline 13 & I-10 to Phoenix (State Line) \\
		\hline 14 & San Diego \\
		\hline
	\end{tabular}
\end{table}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = \linewidth]{figs/R_California_Model_3_Fresno.png}
	\caption{Selected locations and charging stations for California case study}
%	\label{fig:california_atlas}
\end{figure}

\begin{description}
	\item[SC 1] Generic \gls{icev}
	\item[SC 2] Tesla Model 3 with high charger usability (97\%), low arrival rate (10  - 60 min), and neutral risk attitude.
	\item[SC 3] Chevrolet Bolt EV with high charger usability (75\%), low arrival rate (10  - 60 min), and aggressive risk attitude.
	\item[SC 4] Chevrolet Bolt EV with high charger usability (75\%), low arrival rate (10  - 60 min), and cautious risk attitude.
\end{description}
...
%	\label{tab:locations}
	\begin{tabular}{|C{\linewidth * 1 / 5}|C{\linewidth * 1 / 5}|C{\linewidth * 1 / 5}|C{\linewidth * 1 / 5}|C{\linewidth * 1 / 5}|}
		\hline Index & SC 1 & SC 2 & SC 3 & SC 4 \\
		\hline 0 & 9.73 & 10.44 & 13.55 &  \\
		\hline 1 & 7.51 & 7.95 &  &  \\
		\hline 2 & 5.92 & 6.21 &  &  \\
		\hline 3 & 4.91 & 5.04 &  &  \\
		\hline 4 & 5.19 & 5.34 &  &  \\
