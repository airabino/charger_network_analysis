...
sg_t = src.experiment.tesla_network(graph)
...
#     open('FacResults/Bolt_np.pkl', 'wb')
# )
...
# pkl.dump(
#     [expectations, values, paths],
#     open('FacResults/Model_3_np.pkl', 'wb')
# )
...
# pkl.dump(
#     [expectations, values, paths],
#     open('FacResults/Model_3_t.pkl', 'wb')
# )
...
pkl.dump(
    [expectations, values, paths],
    open('FacResults/Model_3_c.pkl', 'wb')
)